...
void pesquisar_produto(vector<Produto> &produtos){
    ...
    cout<<"Nome do produto a pesquisar: ";
    getline(cin,nome);
...
void listar_stock_baixo(vector<Produto> &produtos){
...
void ordenar_preco(vector<Produto> &produtos){
    ...
    cout<<"Produtos ordenados por preco.\n";
}

void total_stock(vector<Produto> &produtos){
    ...
    cout<<"Total de unidades em stock: "<<total<<endl;
}
...
int main(){
    ...
    do{
        ...
        cout<<"11 - Pesquisar Produto\n";
        cout<<"12 - Listar Produtos com Stock Baixo\n";
        cout<<"13 - Ordenar Produtos por Preço\n";
        cout<<"14 - Listar total de produtos em stock\n";
        cout<<"0 - Sair\n";
        ...
        switch(opcao){
            ...
            case 12:
                listar_stock_baixo(produtos);
                break;

            case 13:
                ordenar_preco(produtos);
                break;

            case 14:
            total_stock(produtos);
            break;
        }
